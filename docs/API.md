...
| Тип задания | Как проверяет |
|-------------|---------------|
| `choice` | Точное сравнение строки |
| `number` | Сравнение с допуском (±0.01) |
| `string` | Нормализация (нижний регистр, пробелы) + сравнение |
| `multi` | Совпадение множества |
